<%-- 
    Document   : AdicionarOrdemDeServicoComputador
    Created on : 16/05/2017, 21:39:07
    Author     : Diego
--%>
...
<html>
    ...
    <center> <h1>Adicionar Ordem de Serviço</h1> </center>
        ...
        <form method="POST" action="AdicionarOrdemDeServicoComputador">        
            <table width="50%" align="center" border="1">
                ...
                <td size="50"><select name="situacao" multiple size="2">
                    ...
                    <option value="Aguardando Oçamento">Aguardando Orçamento</option>
