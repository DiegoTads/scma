 ...
 * @author Diego
 */
@WebServlet(name = "EditarOrdemDeServico", urlPatterns = {"/EditarOrdemDeServico"})
public class EditarOrdemDeServico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            {
                rd=request.getRequestDispatcher("sucesso_editar_ordem_de_servico.jsp");
