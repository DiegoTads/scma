 ...
 * @author Diego
 */
@WebServlet(name = "PesquisarOrdemDeServicoComputador", urlPatterns = {"/PesquisarOrdemDeServicoComputador"})
public class PesquisarOrdemDeServicoComputador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            {
                rd=request.getRequestDispatcher("sucesso_pesquisar_ordem_de_servico_computador.jsp");
