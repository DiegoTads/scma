 ...
 * @author Diego
 */
@WebServlet(name = "ListarOrdemDeServicoComputador", urlPatterns = {"/ListarOrdemDeServicoComputador"})
public class ListarOrdemDeServicoComputador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {
                rd=request.getRequestDispatcher("listar_ordem_de_servico_computador.jsp");
