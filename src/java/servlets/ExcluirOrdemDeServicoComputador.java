 ...
 * @author Diego
 */
@WebServlet(name = "ExcluirOrdemDeServicoComputador", urlPatterns = {"/ExcluirOrdemDeServicoComputador"})
public class ExcluirOrdemDeServicoComputador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            {
                rd=request.getRequestDispatcher("sucesso_excluir_ordem_de_servico_computador.jsp");
