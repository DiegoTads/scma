 ...
 * @author Diego
 */
@WebServlet(name = "ExcluirOrdemDeServicoComputador1", urlPatterns = {"/ExcluirOrdemDeServicoComputador1"})
public class ExcluirOrdemDeServicoComputador1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {
                response.sendRedirect("excluir_ordem_de_servico_computador.jsp");
            }
        }
    }
