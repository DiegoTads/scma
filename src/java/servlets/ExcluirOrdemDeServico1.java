 ...
 * @author Diego
 */
@WebServlet(name = "ExcluirOrdemDeServico1", urlPatterns = {"/ExcluirOrdemDeServico1"})
public class ExcluirOrdemDeServico1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {
                response.sendRedirect("excluir_ordem_de_servico.jsp");
            }
        }
    }
