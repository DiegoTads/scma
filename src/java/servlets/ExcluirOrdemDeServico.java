 ...
 * @author Diego
 */
@WebServlet(name = "ExcluirOrdemDeServico", urlPatterns = {"/ExcluirOrdemDeServico"})
public class ExcluirOrdemDeServico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            {
                rd=request.getRequestDispatcher("sucesso_excluir_ordem_de_servico.jsp");
